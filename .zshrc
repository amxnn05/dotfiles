...
# Example aliases
 ...
 alias c="clear"
 alias cc="./copyfile.sh"
 alias rr="./cprun.sh"
 alias ii="./writein.sh"
 alias nn="./new_file.sh"
 alias vm="vim code.cpp"
 alias ee="./edge.sh"
 alias er="./edgerun.sh"
 alias cp="cd CP/"
 alias dev="cd Dev/"
 alias e="exit"
 alias ds="jupyter notebook"
 autoload -Uz compinit
compinit
zstyle ':completion:*' menu select
# Correct TERM inside tmux
...
__conda_setup="$('/home/aman/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
